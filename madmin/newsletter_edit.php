...
<div id="arianne">
  <a href="#"><?php echo _("Newsletter"); ?></a> > <a href="index.php?pid=114"><?php echo _("Newsletters"); ?></a> > <?php echo _("Modifier une newsletter"); ?>
</div>
...
<div id="first_contener">
  <h1><?php echo _("Modifier une newsletter"); ?></h1>
  <form id="formulaire" action="newsletter_test_edit.php" method="post" name="formulaire" enctype="multipart/form-data">
    ...
    <table id="main_table_form">
          ...
          <div id="page">
            <table>
              <tr>
                ...
                <td class="form_box" style="width:70%"><input type="text" name="name" style="width:200px" class="required" value="<?php echo stripslashes($newsletter->name); ?>"></td>
              </tr>
              <tr>
                  ...
                  <select name="template" id="template">
                    <?php 
                      ...
                      foreach ($elements as $el){
                        echo "<option value='$el->id' "; if ($el->id == $newsletter->template_id) echo "selected='selected'"; echo ">$el->name</option>";
                      }
                    ?>
                  </select>
                </td>
              ...
              <tr>
                ...
                <td class="form_box" style="width:70%"><input type="text" name="subject" style="width:200px" value="<?php echo stripslashes($newsletter->subject); ?>"></td>
              </tr>
              <tr>
                ...
                <td class='form_box'>
                  <select name='content_type' onchange='javacript:change_content_type(this.value);'>
                    <option value='file' <?php if ($newsletter->content_type == 'file') echo "selected='selected'"; echo ">" ._("Fichier"); ?></option>
                    <option value='code' <?php if ($newsletter->content_type == 'code') echo "selected='selected'"; echo ">" ._("Code"); ?></option>
                  </select>
                </td>
              </tr>
              <tr>
                ...
                <td class='form_box' id='content_value'>
                  <div id='editor' <?php if ($newsletter->content_type == 'file') echo "style='display:none'";?>>
                    <textarea class='tinymce' id='code' name='code' style='width:800px;height:600px'><?php if ($newsletter->content_type == 'code') echo stripslashes($newsletter->content); ?></textarea>
                  </div>
                  <div id='file' <?php if ($newsletter->content_type == 'code') echo "style='display:none'"; ?>>
                    <input type='file' name='file_content' />&nbsp;&nbsp;<?php if ($newsletter->content_type == 'file') echo "Actuellement : " .$newsletter->content; ?>
                  </div>
                </td>
              </tr>
              <tr>
      ...
      <tr>
        <td colspan="2">
          ...
          &nbsp;&nbsp;
          <input type="submit" value="<?php echo _("Modifier"); ?>" onclick="javascript:tabs.select(0)" />
        </td>
      </tr>
    </table>      
  </form>
