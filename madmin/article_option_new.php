...
<div id="arianne">
  <a href="#"><?php echo _("Shop"); ?></a> > <a href="index.php?pid=281"><?php echo _("Liste des options d'article"); ?></a> > Ajouter une option d'article
</div>
...
<div id="first_contener">
  <h1><?php echo _("Ajout d'une option d'article"); ?></h1>  

  <form id="form_new_article_option" action="article_option_test_new.php" method="post" name="form_new_article_option" enctype="multipart/form-data">
    ...
    <table>
      ...
      <tr>
        ...
        <td><input type="text" class="required currency" name="price" style="width:200px" value="0" /> CHF</td>
      </tr>
      <tr>
        ...
        <td>
          <select name="use_stock" onchange="change_stock(this);">
            <option value="1" <?php if ($use_stock == 1) echo "selected='selected'"; ?>><?php echo _("Oui"); ?></option>
            <option value="0" <?php if ($use_stock == 0) echo "selected='selected'"; ?>><?php echo _("Non"); ?></option>
          </select>
        </td>
      </tr>
      <tr>
