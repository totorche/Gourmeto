<?php
	...
	$mcFileManagerConfig['filesystem.path'] = '../../../../../../../pictures/media'; // absolute or relative from this script path, optional.
	$mcFileManagerConfig['filesystem.rootpath'] = '../../../../../../../pictures/media'; // absolute or relative from this script path, required.
	...
	$mcFileManagerConfig['authenticator.login_page'] = "login.php";
