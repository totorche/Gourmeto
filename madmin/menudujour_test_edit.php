<?php 
  ...
  try{
    $menu = new miki_menudujour($_POST['id']);
    ...
    // supprime tous les plats liés et menu du jour
    $menu->remove_all_plats();
    // ainsi que tous les prix
    $menu->remove_all_prices();
    ...
    $_SESSION['success'] = 1;
    $_SESSION['msg'] = _("Le menu a été modifié avec succès");
    
    // puis redirige vers la page précédente
    $referer = "index.php?pid=303&id=$menu->id";
