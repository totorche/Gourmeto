<head>
  ...
  <script type="text/javascript">
    ...
    window.addEvent('domready', function() {
      ...
      var myCheckForm = new checkForm($('form_new_place'),{
                                        useAjax: false,
                                        errorPlace: 'bottom'
                                      });
  ...
  <style type="text/css">
    ...
    #form_new_place input[type=text]{
      width: 250px;
    }
    
    #form_new_place textarea{
      width: 400px;
      height: 100px;
    }
...
<div id="arianne">
  <a href="#"><?php echo _("Contenu"); ?></a> > <a href="index.php?pid=171"><?php echo _("Liste des bonnes adresses"); ?></a> > Ajout d'une bonne adresse
</div>
...
<div id="first_contener">
  <h1><?php echo _("Ajout d'une bonne adresse"); ?></h1>  

  <form id="form_new_place" action="place_test_new.php" method="post" name="formulaire" enctype="multipart/form-data">
    ...
    <table>
              ...
              foreach ($languages as $l){
                ...
                <div id='content_$l->code' class='lang_content' lang='$l->code'>
                  <table>
                    ...
                    <tr>
                      <td>" ._("Titre : ") ."</td>
                      <td><input type='text' id='title_$l->code' name='title[$l->code]' value='" .((isset($_SESSION['saved_place'])) ? $_SESSION['saved_place']->title[$l->code] : "") ."' /></td>
                    </tr>
                    <tr>
                      <td>" ._("Description : ") ."</td>
                      <td><textarea name='description[$l->code]' id='description_$l->code'>" .((isset($_SESSION['saved_place'])) ? $_SESSION['saved_place']->description[$l->code] : "") ."</textarea></td>
                    </tr>
                    <tr>
      ...
      <tr>
        ...
        <td>
          <select name="state">
            <option value="1" <?php if (isset($_SESSION['saved_place']) && $_SESSION['saved_place']->state == 1) echo " selected='selected'"; ?>>Oui</option>
            <option value="0" <?php if (isset($_SESSION['saved_place']) && $_SESSION['saved_place']->state == 0) echo " selected='selected'"; ?>>Non</option>
          </select>
        </td>
      </tr>
      <tr>
          ...
          <select name="category">
            <?php
              foreach($place_category as $key=>$cat){
                ...
                if (isset($_SESSION['saved_place']) && $_SESSION['saved_place']->category == $cat) echo " selected='selected'"; 
                echo ">$cat</option>"; 
              }
            ?>
          </select>
      ...
      <tr>
        <td>Adresse</td>
        <td><input type="text" class="" name="address" value="<?php echo ((isset($_SESSION['saved_place'])) ? $_SESSION['saved_place']->address : "") ?>" /></td>
      </tr>
      <tr>
        <td>Code postal</td>
        <td><input type="text" class=" numeric" name="npa" value="<?php echo ((isset($_SESSION['saved_place'])) ? $_SESSION['saved_place']->npa : "") ?>" /></td>
      </tr>
      <tr>
        <td>Localité</td>
        <td><input type="text" class="" name="city" value="<?php echo ((isset($_SESSION['saved_place'])) ? $_SESSION['saved_place']->city : "") ?>" /></td>
      </tr>
      <tr>
        <td>Pays</td>
        <td>
          <select name="country">
            <?php
              foreach($country_list as $key=>$el){
                ...
                if (isset($_SESSION['saved_place']) && $_SESSION['saved_place']->country == $el) echo " selected='selected'"; 
                elseif (!isset($_SESSION['saved_place']) && $el == "Suisse") echo " selected='selected'";
                echo ">$el</option>"; 
              }
            ?>
          </select>
      ...
      <tr>
        <td>Téléphone</td>
        <td><input type="text" name="tel" class="phone" value="<?php echo ((isset($_SESSION['saved_place'])) ? $_SESSION['saved_place']->tel : "") ?>" /></td>
      </tr>
      <tr>
        <td>Email</td>
        <td><input type="text" class="email" name="email" value="<?php echo ((isset($_SESSION['saved_place'])) ? $_SESSION['saved_place']->email : "") ?>" /></td>
      </tr>
      <tr>
        <td>Site Internet</td>
        <td><input type="text" class="requiredLink" name="web" value="<?php echo ((isset($_SESSION['saved_place'])) ? $_SESSION['saved_place']->web : "") ?>" /></td>
      </tr>
      <tr>
