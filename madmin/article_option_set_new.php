...
<div id="arianne">
  <a href="#"><?php echo _("Shop"); ?></a> > <a href="index.php?pid=291"><?php echo _("Liste des sets d'options"); ?></a> > Ajouter un set d'options
</div>
...
<div id="first_contener">
  <h1><?php echo _("Ajouter un set d'options"); ?></h1>
  <form id="formulaire" action="article_option_set_test_new.php" method="post" name="formulaire" enctype="application/x-www-form-urlencoded">
