...
<div id="arianne">
  <a href="#"><?php echo _("Disposition"); ?></a> > <a href="index.php?pid=31"><?php echo _("Section"); ?></a> > <?php echo _("Ajouter une section"); ?>
</div>
...
<div id="first_contener">
  <h1><?php echo _("Ajouter une section"); ?></h1>
  <form id="formulaire" action="template_part_test_new.php" method="post" name="formulaire" enctype="application/x-www-form-urlencoded">
    ...
    <table id="main_table_form">
      ...
      <tr>
        ...
        <td class="form_box">
          <textarea name="content" style="width:800px;height:500px"><?php echo $content; ?></textarea><br />
      ...
      <tr>
        ...
        <td style="height:250px">
            ...
            <div style="float:left;width:380px;height:200px">
              ...
              <div id="part_right" style="background-color:#d3d3d3;border:solid 1px #999999;float:left;width:100%;height:100%;overflow-y:scroll"></div>
            </div>
        </td>
      </tr>
      <tr>
