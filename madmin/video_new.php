<head>
  ...
  <script type="text/javascript">
    ...
    window.addEvent('domready', function() {
      ...
      var myCheckForm = new checkForm($('form_new_video'),{
                                        useAjax: false,
                                        errorPlace: 'bottom'
                                      });
  ...
  <style type="text/css">
    ...
    #form_new_video input[type=text]{
      width: 250px;
    }
    
    #form_new_video textarea{
      width: 400px;
      height: 100px;
    }
...
<div id="arianne">
  <a href="#"><?php echo _("Contenu"); ?></a> > <a href="index.php?pid=231"><?php echo _("Liste vidéos"); ?></a> > Ajout d'une vidéo
</div>
...
<div id="first_contener">
  <h1><?php echo _("Ajout d'une vidéo"); ?></h1>  

  <form id="form_new_video" action="video_test_new.php" method="post" name="formulaire" enctype="multipart/form-data">
    ...
    <table>
              ...
              foreach ($languages as $l){
                ...
                <div id='content_$l->code' class='lang_content' lang='$l->code'>
                  <table>
                    ...
                    <tr>
                      <td>" ._("Titre : ") ."</td>
                      <td><input type='text' id='title_$l->code' name='title[$l->code]' value='" .((isset($_SESSION['saved_video'])) ? $_SESSION['saved_video']->title[$l->code] : "") ."' /></td>
                    </tr>
                    <tr>
                      <td>" ._("Description : ") ."</td>
                      <td><textarea name='description[$l->code]' id='description_$l->code'>" .((isset($_SESSION['saved_video'])) ? $_SESSION['saved_video']->description[$l->code] : "") ."</textarea></td>
                    </tr>
                    <tr>
      ...
      <tr>
        ...
        <td>
          <select name="state">
            <option value="1" <?php if (isset($_SESSION['saved_video']) && $_SESSION['saved_video']->state == 1) echo " selected='selected'"; ?>>Oui</option>
            <option value="0" <?php if (isset($_SESSION['saved_video']) && $_SESSION['saved_video']->state == 0) echo " selected='selected'"; ?>>Non</option>
          </select>
        </td>
      </tr>
      <tr>
        ...
        <td>
          <select name="type">
            <option value="youtube" <?php if (isset($_SESSION['saved_video']) && $_SESSION['saved_video']->type == 'youtube') echo " selected='selected'"; ?>>Youtube</option>
            <option value="vimeo" <?php if (isset($_SESSION['saved_video']) && $_SESSION['saved_video']->type == 'vimeo') echo " selected='selected'"; ?>>Vimeo</option>
          </select>
        </td>
      </tr>
      <tr>
          ...
          <select name="category">
            <?php
              foreach($video_category as $key=>$cat){
                ...
                if (isset($_SESSION['saved_video']) && $_SESSION['saved_video']->category == $key) echo " selected='selected'"; 
                echo ">$cat</option>"; 
              }
            ?>
          </select>
      ...
      <tr>
        ...
        <td>
          <input type="text" name="video" class="required" value="<?php echo ((isset($_SESSION['saved_video'])) ? $_SESSION['saved_video']->video : ""); ?>" />
          <br /><br />
