...
if (!test_right(79) && !test_right(80) && !test_right(81)){
...
window.addEvent('domready', function() {
  var myCheckForm = new checkForm($('search_elements_form'),{
                                        useAjax: true,
  ...
  search_elements(page_now, '', 'date', 'asc');
});
...
function search_elements(page, search_data, order, order_t){
  ...
  var req = new Request({url:'menudujour_search.php', 
...
<div id="arianne">
  <a href="#"><?php echo _("Contenu"); ?></a> > <?php echo _("Menus du jour"); ?>
</div>
...
<div id="first_contener">
  <h1><?php echo _("Menus du jour actuels"); ?></h1>
  
  <form id="search_elements_form" action="menudujour_search.php" method="post" name="search_elements_form" enctype="application/x-www-form-urlencoded" style="margin:0 0 20px 0">
  ...
  <div style="margin-bottom:10px">
    <?php 
    if (test_right(79)){ ?>
      <a href="index.php?pid=302" title="<?php echo _("Ajouter un menu du jour"); ?>"><img src="pictures/newobject.gif" border="0" alt="<?php echo _("Ajouter un menu du jour"); ?>" style="vertical-align:middle" /><?php echo _("Ajouter un menu du jour"); ?></a>
    <?php } ?>
  </div>
  ...
  <div style="margin-top:10px;float:left">
    <?php 
    if (test_right(79)){ ?>
      <a href="index.php?pid=302" title="<?php echo _("Ajouter un menu du jour"); ?>"><img src="pictures/newobject.gif" border="0" alt="<?php echo _("Ajouter un menu du jour"); ?>" style="vertical-align:middle" /><?php echo _("Ajouter un menu"); ?></a>
    <?php } ?>
  </div>
