<?php
  /**
   * Affiche une liste des différentes bonnes adresses
   */       
  ...
  $elements = Miki_place::get_all_places(false, "position", "asc", $max_elements, $p, $nb_elements);
?>
...
<?php
  if (sizeof($elements) == 0){
    echo "<div>" ._("Aucune bonne adresse n'a été trouvé") ."</div>";
  }
  else{
              ...
              foreach($elements as $el){
                ...
                echo "<li itemscope itemtype='http://schema.org/PostalAddress'>";
                  ...
                  echo "<div class='place_text'>
                        ...
                        <div class='place_details'><a href='$link' title='" ._("Voir les détails") ."'>" ._("Détails") ."</a></div>
                      </li>";
              }
      echo "</ul>
          </div>";
