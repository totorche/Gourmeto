<?php
  $facture_avant_form_url = "[miki_page='shop_paiement_ok']";
  
  // affichage des input dans le formulaire de paiement
  function facture_avant_print_form($order, $miki_person){
    echo "<input type='hidden' name='order_id' value='$order->id' />\n";
    echo "<input type='hidden' name='miki_payment_type' value='facture_avant' />\n";
  }
  
  // fonction servant au traitement de la commande lorsque l'utilisateur arrive sur la page de fin de paiement
  function facture_avant_payment_ok_user($args){
  ...
  function facture_avant_payment_error_user($args){}
